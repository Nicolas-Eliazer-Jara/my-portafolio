...
export default function Nav() {
  ...
  return (
    <nav className="relative mx-auto w-[95%] z-50 ">
      <motion.div
        className="flex flex-col text-exception shadow-lg shadow-black/30 bg-white rounded-md lg:text-[14px] md:text-[10px]"
        ...
        >
          <div className="flex items-center justify-between h-full px-5">
            ...
            <div className="flex items-center gap-3">
              {/* Móvil: dark a la izquierda del menú */}
              ...
              {/* Desktop: menú + idioma + dark */}
              <div className="hidden  md:flex items-center gap-3">
              <motion.div className="hidden  md:flex justify-center items-center  shadow-lg shadow-black/30 text-[#030503] bg-white rounded-md lg:text-[14px] md:text-[10px]">
              {["home", "aboutNav", "work", "tecnologies", "contact"].map(
                ...
                <div
                  ref={wrapperRef}
                  className="relative lg:text-[12px] md:text-[10px] lg:w-[130px] md:w-[90px]"
                >
                  <button
                    type="button"
                ...
                <button
                  onClick={toggleTheme}
                  className="hover:cursor-pointer md:ml-4"
                >
                  <Image
                    src={
                      theme === "dark"
          ...
          {menuOpen && (
            <div className="md:hidden absolute right-0 top-full text-[#030503] bg-white rounded-b-lg shadow-lg w-[150px] text-center text-[9px]">
              {["home", "aboutNav", "work", "contact", "tecnologies"].map(
                (key) => (
                  <a
                    key={key}
                    onClick={() => {
