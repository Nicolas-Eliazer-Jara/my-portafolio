    ...
    <section id="contact">
      <div className="pt-5 font-inter mt-10 w-[95%] mx-auto rounded-[10px] mb-5 bg-[#030503] text-[#f1f0f1]">
        <div className="w-[90%] mx-auto border-b-[1px] border-[#db5c32]">
          <h1 className="lg:text-[14px] md:text-[11px] text-[8px]  text-center pb-5">Nicolas Eliazer Jara</h1>
        </div>
        ...
        <div className="flex lg:text-[13px] md:text-[10px] text-[8px] p-5 justify-center">
